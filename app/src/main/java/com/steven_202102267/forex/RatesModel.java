package com.steven_202102267.forex;
public class RatesModel { private double AUD, BND, BTC, EUR, GBP, HKD, IDR, INR, JPY, MYR; public RatesModel(){}public double getAUD() {return AUD;}
